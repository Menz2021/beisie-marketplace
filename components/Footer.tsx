        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-2xl font-bold text-white">Beisie</span>
            </div>
          ...
          {/* Payment Methods */}
          <div>
            <h3 className="text-lg font-bold text-white mb-4">We Accept</h3>
            ...
            <div className="mt-6">
              <Link 
                href="/contact" 
                className="inline-flex items-center text-purple-400 hover:text-white transition-colors text-sm font-medium"
              >
