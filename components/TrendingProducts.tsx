...
export function TrendingProducts() {
  ...
  const toggleFavorite = async (product: TrendingProduct) => {
    try {
  ...
  const handleUpdateQuantity = (product: TrendingProduct, newQuantity: number) => {
              ...
              <div className="flex space-x-4 pb-4" style={{ width: 'max-content' }}>
                {trendingProducts.map((product, index) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow group relative flex-shrink-0 w-64"
                >
